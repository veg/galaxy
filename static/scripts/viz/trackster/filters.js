define("viz/trackster/filters", ["exports", "utils/localization", "libs/underscore"], function(exports, _localization, _underscore) {
    "use strict";
            ...
            (function run_filter(input_dataset_id, filters) {
                ...
                $.getJSON(run_tool_url, url_params, function(response) {
                    if (response.error) {
                        // General error.
                        Galaxy.modal.show({
                            title: (0, _localization2.default)("Filter Dataset"),
                            body: "Error running tool " + tool_id,
                            buttons: {
                                Close: Galaxy.modal.hide()
                            }
                        });
                    } else if (filters.length === 0) {
                        // No more filters to run.
                        Galaxy.modal.show({
                            title: (0, _localization2.default)("Filtering Dataset"),
