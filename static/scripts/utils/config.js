define("utils/config", ["exports", "libs/underscore", "libs/backbone", "viz/trackster/util"], function(exports, _underscore, _backbone, _util) {
    "use strict";
        ...
        render: function render() {
            ...
            this.collection.each(function(param, index) {
                ...
                if (type === "bool") {
                    ...
                    var new_color_icon = $("<a href='javascript:void(0)'/>").addClass("icon-button arrow-circle").appendTo(container_div).attr("title", "Set new random color").tooltip();
