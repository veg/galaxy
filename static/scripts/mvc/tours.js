    ...
    var hooked_tour_from_data = function hooked_tour_from_data(data) {
        _.each(data.steps, function(step) {
            ...
            if (step.path) {
                ...
                // routing matures.
                console.warn("This Galaxy Tour is attempting to use path navigation.  This is known to be unstable and can possibly get the Galaxy client 'stuck' in a tour, and at this time is not allowed.");
                delete step.path;
            }
        });
        return data;
